...
export default function App() {
  const { selectedSettings, setSelectedSettings, updateFunction, setVideos, setReverseSettings } = useGlobalStore();
  ...
  const onSiteClick = (name) => {
    console.log("Site clicked:", name);
      // get fresh selected sites from global state
      const { selectedSettings } = useGlobalStore.getState();
      console.log("Current selected sites on fresh reload:", selectedSettings.sites);
      const s = Object.keys(selectedSettings.sites);
      // console.log("Toggling site:", name, "Current selected sites:", s);
